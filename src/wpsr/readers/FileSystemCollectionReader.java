...
public class FileSystemCollectionReader extends CollectionReader_ImplBase {
	...
	if (!directory.exists() || !directory.isDirectory()) {
	    throw new ResourceInitializationException(
		    ...
		    new Object[] { PARAM_INPUTDIR, getMetaData().getName(),
			    directory.getPath() });
	}
	...
	final String text = FileUtils.file2String(file, mEncoding);
	// put document in CAS
	...
	final SourceDocumentInformation srcDocInfo = new SourceDocumentInformation(
		jcas);
